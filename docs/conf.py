...
classname = "Modern Application Architecture"

# OPTIONAL: The URL to the GitHub Repository for this class
github_repo = "https://github.com/fbchan/modern-apps-arch-demo-guide"
...
eventname = "Modern Application Architecture DEMO Guide"
...
if 'github_repo' in locals() and len(github_repo) > 0:
    rst_prolog += """
.. |repoinfo| replace:: The content contained here leverages various modern application
              ...
              capabilities. The content leverage from the GitHub reposiroty at %s.
""" % (github_repo)
else:
